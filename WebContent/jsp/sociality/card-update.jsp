...
<hr class="divider1">
<form id="_form" class="form-center" action="card_update" method="post" enctype="multipart/form-data">
		...
		<tr>
				...
				<div class="formField" data-attr="sampleDropDownList">
					...
					<div class="fieldBlock" fullWidth="false">
						<div style="display:inline" id="BoSample_sampleDropDownList_field">
							<select separator="&amp;nbsp;&amp;nbsp;" class="form-control" name="bBussinessCardCategoryGuid" id="bBussinessCardCategoryGuid">	
 								...
 								<c:forEach var="list" items="${responseVO.category}">
	 								<c:choose>
									  <c:when test="${list.guid == responseVO.bBussinessCardCategoryGuid}">
										   <option value="${list.guid}" selected="selected">${list.name}</option>
									  </c:when>
									  <c:otherwise>
			...
			<td>
				<div class="formField" data-attr="sampleDropDownList">
					...
					<div class="fieldBlock" fullWidth="false">
						<div style="display:inline" id="BoSample_sampleDropDownList_field">
							<select separator="&amp;nbsp;&amp;nbsp;" class="form-control" name="bBussinessCardAttributeGuid" id="bBussinessCardCategoryGuid">	
			...
			<td>
				<div class="formField" data-attr="sampleDropDownList">
					...
					<div class="fieldBlock" fullWidth="false">
						<div style="display:inline" id="BoSample_sampleDropDownList_field">
							<select separator="&amp;nbsp;&amp;nbsp;" class="form-control" name="bBussinessCardStatusGuid" id="bBussinessCardCategoryGuid">	
		...
		<tr>
			<th>
				<div class="form-group">
					...
					<input  type="text" name="name" id="name" value="${responseVO.name}">
				</div>
			</th>
			<th>
				<div class="form-group">
					<label for="password">抬頭:</label> 
					<input  type="text" name="title" id="title" value="${responseVO.title}">
				</div>
			</th>
			<th>
				<div class="form-group">
					<label for="password">暱稱:</label> 
					<input  type="text" name="nickname" id="nickname" value="${responseVO.nickname}">
				</div>
			</th>
		</tr>
		<tr>
			<th>
				<div class="form-group">
					...
					<input  type="text" name="cellphoneNumber" id="cellphone" value="${responseVO.cellphoneNumber}">
				</div>
			</th>
			<th>
				<div class="form-group">
					<label for="password">電子郵件:</label> 
					<input type="text" name="email" id="email" value="${responseVO.email}">
				</div>
			</th>
			<th>
				<div class="form-group">
					<label for="password">公司名稱:</label> 
					<input  type="text" name="companyName" id="companyName" value="${responseVO.companyName}">
				</div>
			</th>
		</tr>
		<tr>
			<th>
				<div class="form-group">
					...
					<input  type="text" name="companyAddress" id="address" value="${responseVO.companyAddress}">
				</div>
			</th>
			<th>
				<div class="form-group">
					<label for="account">公司電話:</label> 
					<input  type="text" name="companyPhoneNumber" id="companyPhone" value="${responseVO.companyPhoneNumber}">
				</div>
			</th>
			<th>
				<div class="form-group">
					<label for="password">特徵:</label> 
					<input  type="text" name="feature" id="feature" value="${responseVO.feature}">
				</div>
			</th>
		</tr>
		<tr>
			<th>
				<div class="form-group">
					...
					<input  type="text" name="birthday" id="birthday" value="${responseVO.birthday}">
				</div> 
			</th>
			<th>
				<div class="form-group">
					<label for="account">婚姻:</label> 
					<input  type="text" name="marrage" id="married" value="${responseVO.marrage}">
				</div>
			</th>
			<th>
				<div class="form-group">
					<label for="password">初識時間:</label> 
					<input  type="text" name="firstMeetTimeString" id="firstMeetTimeString" value="${responseVO.firstMeetTimeString}">
				</div>
			</th>
		</tr>
		<tr>
			<th>
				<div class="form-group">
					...
					<input  type="text" name="firstMeetLocation" id="firstMeetLocation" value="${responseVO.firstMeetLocation}">
				</div>
			</th>
			<td>
				<div class="form-group">
					<label for="account">備註:</label>
					<input  type="text" name="remark" id="remark" value="${responseVO.remark}"> 
				</div>
			</td>
		</tr>
	</table>
