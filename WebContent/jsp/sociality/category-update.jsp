...
<hr class="divider1">
<form id="_form" class="form-center" action="category_update" method="post" enctype="multipart/form-data">
	...
	<table cellpadding="10">
		<th>
			<div class="form-group">
				<span class="required" style="color:red;">*</span><label for="account">類別名稱:</label> 
