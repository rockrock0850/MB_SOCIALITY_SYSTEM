...
<script type="text/javascript">
	$(function() {
		$('#listGrid').datagrid({
		    width: '700',
		    url:"api/scheduled_list",
		    rownumbers: true,
		    columns:[[
		        { field:'guid',checkbox:true , width:"10%"}, 
		        { field: 'name', title: '預定項目名稱', width:"90%", align:'center'}
		    ]],
		    idField:'guid',
		    singleSelect: false,
		    selectOnCheck: true,
...
<%-- 	<jsp:include page="${requestScope.menu}">
	...
	<c:choose>
	  <c:when test="${categoryMap.msg == '執行成功'}">
	...
	<table>
		<tr>
			...
			<div style="display: inline" id="eventPrefix_field">
				<input class="form-control" type="hidden" value="scheduled"
