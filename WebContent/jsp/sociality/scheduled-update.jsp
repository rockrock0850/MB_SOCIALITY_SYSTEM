...
<hr class="divider1">
<form id="_form" class="form-center" action="scheduled_update" method="post" enctype="multipart/form-data">
	...
	<table cellpadding="10">
		<th>
			<div class="form-group">
				<span class="required" style="color:red;">*</span><label for="account">預定項目名稱:</label> 
				<jsp:include page="${requestScope.inputForm}">
					<jsp:param value="name" name="field"/>
					<jsp:param value="text" name="type"/>
					<jsp:param value="${category.name}" name="val"/>
				</jsp:include>
				<input type="hidden" id="guid" name="guid" value="${category.guid}"/>
			</div>
		</th>
	</table>
</form>
