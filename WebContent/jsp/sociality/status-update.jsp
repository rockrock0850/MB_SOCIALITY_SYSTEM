...
<hr class="divider1">
<form id="_form" class="form-center" action="status_update" method="post" enctype="multipart/form-data">
	...
	<table cellpadding="10" >
		<th>
			<div class="form-group">
				<span class="required" style="color:red;">*</span><label for="account">狀態名稱:</label> 
