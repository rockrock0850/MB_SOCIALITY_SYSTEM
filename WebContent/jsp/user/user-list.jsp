...
<link
	...
	rel="stylesheet">
<link
	href="${pageContext.request.contextPath}/resources/css/bootstrap/easyui.css"
	rel="stylesheet">
<link href="${pageContext.request.contextPath}/resources/css/color.css"
	rel="stylesheet">
...
<script
	src="${pageContext.request.contextPath}/resources/js/jquery.easyui.min.js"></script>
<script
	src="${pageContext.request.contextPath}/resources/js/easyui-lang-zh_TW.js"></script>
...
<body>
	...
	<table>
		<tr>
			...
			<td><a class="l-btn l-btn-small l-btn-plain"> <span
					class="l-btn-left"> <span class="l-btn-text">
							<button class="btn btn-warning" title="編輯" onclick="Modify($(this));">
		...
		<table>
			...
			<table class="easyui-datagrid" id="listGrid"
				data-options="fitColumns: true, fixed: true,rownumbers: true, pagination: true">
				<thead>
					<tr>
						<th data-options="field:'ck',checkbox:true"></th>
						<th data-options="field:'code', width:10">Code</th>
						<th data-options="field:'name', width:10">Name</th>
						<th data-options="field:'price', width:10">Price</th>
					</tr>
				</thead>
				<tbody>
					<tr>
			...
			<div style="display: inline" id="distinguishProperty_field">
				<input data-label="範例文字輸入" class="form-control" type="hidden"
					value="serial" name="distinguishProperty" id="distinguishProperty" />
			</div>
