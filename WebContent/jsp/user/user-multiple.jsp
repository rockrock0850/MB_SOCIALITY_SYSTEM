...
eval("parent."+ajaxOnSendAfterChooseData+"('"+JSON.stringify(selectedList)+"')"); */
dialogCls.close();
}
...
top.window.location.href = 'http://test2.everywhere.com.tw:83/st/EW1/backend.php/sys';
}
...
<table class="easyui-datagrid" id="listGrid" idField="guid" fit="true" rownumbers="false" pagination="true" striped="true" pageList="[25,50,100]" pageSize="25"  nowrap="false" multiHeader="" for="" fitColumns="true" multiSort="true" sortName="serial" sortOrder="asc" singleSelect="false" data-options="toolbar:listGridToolBar,onBeforeLoad:onBeforeLoad,onLoadSuccess:onLoadSuccess">
	<thead>
		<tr>
			<th align="center" width="50" checkbox="true" field="guid" data-options="">
				<label style="margin:0;" for="BoSample_guid">Guid</label>
			</th>
			<th halign="center" width="300" fixed="true" sortable="true" field="serial" data-options="">
				<label style="margin:0;" for="BoSample_serial">範例文字輸入</label>
			</th><th halign="center" width="300" fixed="true" sortable="true" field="title" data-options="">
				<label style="margin:0;" for="BoSample_title">Title</label>
			</th>
		</tr>
	</thead>
	<tbody>
